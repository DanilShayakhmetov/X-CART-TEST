 ...
 */
class AdditionalLinksUnder extends \XLite\Module\CDev\Sale\View\TopCategories\AAdditionalLinks
{
    protected function isVisible()
    {
        return parent::isVisible()
            && ShowLinksInCategoryMenu::TYPE_UNDER_CATEGORIES === \XLite\Core\Config::getInstance()->CDev->Sale->show_links_in_category_menu;
    }
}
