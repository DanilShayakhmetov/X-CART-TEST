...
class __TwigTemplate_ab0f8ce82baa4d80cad8a623014775ad80c8daccbb37fd614f5d3291b18a6183 extends \XLite\Core\Templating\Twig\Template
{
...
<div id=\"compare\">
  ";
      ...
      ";
            // line 9
            echo XLite\Core\Templating\Twig\Extension\xcart_twig_escape_filter($this->env, call_user_func_array($this->env->getFunction('widget_list')->getCallable(), [$this->env, $context, [0 => "comparison_table.header"]]), "html", null, true);
            echo "
      </tbody>
      ...
      ";
            // line 20
            echo XLite\Core\Templating\Twig\Extension\xcart_twig_escape_filter($this->env, call_user_func_array($this->env->getFunction('widget_list')->getCallable(), [$this->env, $context, [0 => "comparison_table.header_fixed"]]), "html", null, true);
            echo "
      </tbody>
      <tbody class=\"data\">
      ";
            // line 23
            echo XLite\Core\Templating\Twig\Extension\xcart_twig_escape_filter($this->env, call_user_func_array($this->env->getFunction('widget_list')->getCallable(), [$this->env, $context, [0 => "comparison_table.data"]]), "html", null, true);
            echo "
      </tbody>
    </table>
  ";
...
", "modules/XC/ProductComparison/comparison_table/body.twig", "/mff/xcart/skins/customer/modules/XC/ProductComparison/comparison_table/body.twig");
    }
}
