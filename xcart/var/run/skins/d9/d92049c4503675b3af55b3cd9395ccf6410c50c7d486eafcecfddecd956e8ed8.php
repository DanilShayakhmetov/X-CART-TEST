...
class __TwigTemplate_682ac751b80bf888e5072df5f0d2e3274a4908a424a47ff103f6ad523621c4ad extends \XLite\Core\Templating\Twig\Template
{
  ...
  <div class=\"revenue\">
    <span class=\"label\">";
        // line 6
        echo XLite\Core\Templating\Twig\Extension\xcart_twig_escape_filter($this->env, call_user_func_array($this->env->getFunction('t')->getCallable(), ["Month"]), "html", null, true);
        echo ":</span>
    <span class=\"value\">";
        // line 7
  ...
  ";
      ...
      <span class=\"label\">";
            // line 16
            echo XLite\Core\Templating\Twig\Extension\xcart_twig_escape_filter($this->env, call_user_func_array($this->env->getFunction('t')->getCallable(), ["Last month"]), "html", null, true);
            echo "</span>
      <span class=\"value\">";
            // line 17
...
";
    ...
    {
        return new Source("", "order/statistics/informer/parts/month.twig", "/mff/xcart/skins/admin/order/statistics/informer/parts/month.twig");
    }
}
