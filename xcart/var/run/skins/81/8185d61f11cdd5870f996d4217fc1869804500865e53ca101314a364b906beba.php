...
";
    ...
    {
        return new Source("", "layout/header/header.bar.links.logged.account.twig", "/mff/xcart/skins/crisp_white/customer/layout/header/header.bar.links.logged.account.twig");
    }
}
