...
class __TwigTemplate_d22f335bd75b876c82b68ca0486cd52033579ae74cab067679061deb257ba447 extends \XLite\Core\Templating\Twig\Template
{
...
<xlite-template-code inline-template :interface=\"interface\" :template=\"template\" :weight=\"weight\" :list=\"list\">
  <div class=\"xlite-template-code\" :class=\"classes\" v-data='{{ this.getWidgetData()|raw }}'>
    <div class=\"xlite-template-path\" v-if=\"template\"><span v-text=\"template\"></span></div>
...
</xlite-template-code>", "modules/XC/ThemeTweaker/themetweaker/webmaster_mode/template_code.twig", "/mff/xcart/skins/common/modules/XC/ThemeTweaker/themetweaker/webmaster_mode/template_code.twig");
    }
}
