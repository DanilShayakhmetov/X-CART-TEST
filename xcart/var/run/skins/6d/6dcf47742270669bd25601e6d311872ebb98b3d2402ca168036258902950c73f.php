...
class __TwigTemplate_eea658824f4e8dbd43aabcea7ac8191e181ae79ba655d883023e044626ea0b2e extends \XLite\Core\Templating\Twig\Template
{
  ...
  <div class=\"revenue\">
    <span class=\"label\">";
        // line 6
        echo XLite\Core\Templating\Twig\Extension\xcart_twig_escape_filter($this->env, call_user_func_array($this->env->getFunction('t')->getCallable(), ["Year"]), "html", null, true);
        echo ":</span>
    <span class=\"value\">";
        // line 7
  ...
  ";
      ...
      <span class=\"label\">";
            // line 16
            echo XLite\Core\Templating\Twig\Extension\xcart_twig_escape_filter($this->env, call_user_func_array($this->env->getFunction('t')->getCallable(), ["Last year"]), "html", null, true);
            echo "</span>
      <span class=\"value\">";
            // line 17
...
";
    ...
    {
        return new Source("", "order/statistics/informer/parts/year.twig", "/mff/xcart/skins/admin/order/statistics/informer/parts/year.twig");
    }
}
