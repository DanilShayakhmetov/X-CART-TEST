 ...
 * Add to wishlist
 *
 * @ListChild (list="itemsList.product.grid.customer.buttons", zone="customer", weight="300")
 *
 */
class AddToWishlist extends \XLite\View\Container
{
    /**
     * Checkbox id
     *
    ...
    {
        return 'modules/creator/wishlist/addToWishlist';
    }
}
