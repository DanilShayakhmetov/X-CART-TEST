...
abstract class CouponsAbstract extends \XLite\View\ItemsList\Model\Table
{
     ...
     * @return string
     */
    protected function preprocessCode($value, array $column, \XLite\Module\CDev\Coupons\Model\Coupon $coupon)
    {
     ...
     * @return string
     */
    protected function preprocessComment($value, array $column, \XLite\Module\CDev\Coupons\Model\Coupon $coupon)
    {
        return htmlspecialchars($value);
    }
