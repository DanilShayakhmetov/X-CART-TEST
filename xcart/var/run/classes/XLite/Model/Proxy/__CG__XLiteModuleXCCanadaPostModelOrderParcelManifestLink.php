...
class Link extends \XLite\Module\XC\CanadaPost\Model\Order\Parcel\Manifest\Link implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'manifest', 'storage', 'id', 'rel', 'href', 'idx', 'mediaType', 'apiCallErrors', '_previous_state'];
        }
    ...
    public function setManifest(\XLite\Module\XC\CanadaPost\Model\Order\Parcel\Manifest $manifest = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setManifest', [$manifest]);
    ...
    public function getManifest()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getManifest', []);
