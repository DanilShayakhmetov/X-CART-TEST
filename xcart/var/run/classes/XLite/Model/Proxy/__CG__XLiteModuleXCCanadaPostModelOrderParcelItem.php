...
class Item extends \XLite\Module\XC\CanadaPost\Model\Order\Parcel\Item implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'parcel', 'orderItem', 'amount', '_previous_state'];
        }
    ...
    public function getTotalWeightInKg($adjustFloatValue = false)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTotalWeightInKg', [$adjustFloatValue]);
