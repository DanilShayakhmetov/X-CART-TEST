 ...
 */
class SaleDiscountProduct extends \XLite\Module\CDev\Sale\Model\SaleDiscountProduct implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'saleDiscount', 'product', '_previous_state'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SaleDiscountProduct $proxy) {
    ...
    public function getSaleDiscount()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSaleDiscount', []);

        return parent::getSaleDiscount();
    }
    ...
    public function setSaleDiscount($sale)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSaleDiscount', [$sale]);

        return parent::setSaleDiscount($sale);
    }
