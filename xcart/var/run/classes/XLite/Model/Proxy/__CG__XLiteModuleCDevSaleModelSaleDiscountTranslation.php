 ...
 */
class SaleDiscountTranslation extends \XLite\Module\CDev\Sale\Model\SaleDiscountTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'ogMeta', 'name', 'metaTags', 'metaDesc', 'metaTitle', 'label_id', 'code', 'owner', '_previous_state'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SaleDiscountTranslation $proxy) {
