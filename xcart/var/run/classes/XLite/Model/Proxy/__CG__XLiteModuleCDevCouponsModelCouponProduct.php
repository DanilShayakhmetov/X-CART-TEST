 ...
 */
class CouponProduct extends \XLite\Module\CDev\Coupons\Model\CouponProduct implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'coupon', 'product', '_previous_state'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CouponProduct $proxy) {
