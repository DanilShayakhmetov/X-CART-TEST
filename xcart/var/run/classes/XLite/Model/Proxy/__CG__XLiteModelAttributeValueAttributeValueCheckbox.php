...
class AttributeValueCheckbox extends \XLite\Model\AttributeValue\AttributeValueCheckbox implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'value', 'xpaymentsSubscriptionFeeModifier', 'xpaymentsSubscriptionFeeModifierType', 'priceModifier', 'priceModifierType', 'weightModifier', 'weightModifierType', 'defaultValue', 'id', 'product', 'attribute', 'editLanguage', 'translations', '_previous_state'];
        }
