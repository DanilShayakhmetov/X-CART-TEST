 ...
 */
class Plan extends \XLite\Module\XPay\XPaymentsCloud\Model\Subscription\Plan implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'product', 'isSubscription', 'setupFee', 'calculateShipping', 'daysOfWeek', 'fee', 'type', 'number', 'period', 'reverse', 'periods', '_previous_state'];
        }
    ...
    public function setSetupFee($setupFee)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSetupFee', [$setupFee]);
    ...
    public function getSetupFee()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSetupFee', []);
    ...
    public function getReverse()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getReverse', []);

        return parent::getReverse();
    }
