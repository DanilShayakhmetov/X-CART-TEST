...
class Link extends \XLite\Module\XC\CanadaPost\Model\ProductsReturn\Link implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'return', 'storage', 'id', 'rel', 'href', 'idx', 'mediaType', 'apiCallErrors', '_previous_state'];
        }
    ...
    public function setReturn(\XLite\Module\XC\CanadaPost\Model\ProductsReturn $return = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setReturn', [$return]);
    ...
    public function getReturn()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getReturn', []);
