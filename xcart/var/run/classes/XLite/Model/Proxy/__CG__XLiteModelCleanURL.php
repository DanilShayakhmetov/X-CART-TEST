...
class CleanURL extends \XLite\Model\CleanURL implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'sale_discount', 'page', 'newsMessage', 'id', 'product', 'category', 'cleanURL', '_previous_state'];
        }
    ...
    public function setSaleDiscount(\XLite\Module\CDev\Sale\Model\SaleDiscount $saleDiscount = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSaleDiscount', [$saleDiscount]);

        return parent::setSaleDiscount($saleDiscount);
    }
