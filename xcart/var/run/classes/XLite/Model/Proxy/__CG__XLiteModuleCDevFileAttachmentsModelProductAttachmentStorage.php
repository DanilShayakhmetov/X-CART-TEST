...
class Storage extends \XLite\Module\CDev\FileAttachments\Model\Product\Attachment\Storage implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function canBeSigned($path = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'canBeSigned', [$path]);

        return parent::canBeSigned($path);
    }
    ...
    public function isFileAvailable($path = NULL, $forceFile = false)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isFileAvailable', [$path, $forceFile]);

        return parent::isFileAvailable($path, $forceFile);
    }
